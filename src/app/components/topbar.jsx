      ...
      <div className="flex h-16 items-center px-4 justify-between">
        ...
        <div className="flex items-center gap-2">
          {showBackButton ? (
            <button
              onClick={onBack}
              className="p-2 rounded-full text-on-surface  transition-colors cursor-pointer"
              aria-label="Back"
            >
            ...
            <h1 className="text-primary font-material-headlinesmall">
              Printhub
            </h1>
          )}
          ...
          {showBackButton && (
            <span className="text-on-surface font-material-themetitlelarge truncate max-w-[200px]">
              {title}
            </span>
          )}
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-full text-on-surface hover:bg-color-surface-container transition-colors cursor-pointer"
